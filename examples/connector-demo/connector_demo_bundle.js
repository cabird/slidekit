...
`;
  ...
  // examples/connector-demo/connector_demo.ts
  var C = {
    bg: "#0a0a1a",
    accent1: "#00d4ff",
    accent2: "#7c5cbf",
  ...
  var box = (id, label, x, y, opts = {}) => panel([
  ...
  var title = (text, y) => el(`<h1 style="font-size:52px;font-weight:700;color:${C.text};margin:0">${text}</h1>`, {
    id: "title",
    x: 960,
    y: y || 60,
    anchor: "tc",
  ...
  var subtitle = (text) => el(`<p style="font-size:24px;color:${C.textSec};margin:0">${text}</p>`, {
    id: "subtitle",
    y: below("title", { gap: 8 }),
    x: centerHWith("title"),
    layer: "bg"
  ...
  var slide1 = {
    ...
    elements: [
      ...
      Obstacle Avoidance \xB7 Port Spreading \xB7 Rounded Elbows \xB7 Smart Labels
  ...
  var slide2 = {
    ...
    elements: [
      ...
      panel([
        el(`<div style="font-size:20px;color:${C.accent3};text-align:center">\u{1F6E1}\uFE0F Cache</div>`, { id: "s2-obs1-lbl" })
      ], {
        id: "s2-obs1",
        x: 680,
        y: 260,
      ...
      panel([
        el(`<div style="font-size:16px;color:${C.accent3};text-align:center">\u{1F512} Auth</div>`, { id: "s2-auth-lbl" })
      ], {
        id: "s2-auth",
        x: 1600,
        y: 420,
  ...
  var slide3 = {
    ...
    elements: [
      ...
      el(`<p style="font-size:16px;color:${C.textSec}">Use fromPortOrder / toPortOrder to control which port goes where</p>`, {
        id: "s3-hint",
        layer: "bg",
        y: below("s3-label3", { gap: 4 }),
        x: centerHWith("s3-label3")
      }),
  ...
  var slide4 = {
    ...
    elements: [
      ...
      box("s4-bk1", "Response", 1650, 680, { w: 160, h: 70 }),
      box("s4-bk2", "Request", 1650, 920, { w: 160, h: 70 }),
  ...
  var slide6 = {
    ...
    elements: [
      ...
      // Top tier: clients
      box("arch-web", "\u{1F310} Web App", 350, 180, { w: 200, h: 80, fill: "rgba(0,212,255,0.12)", borderColor: C.accent1 }),
      box("arch-mobile", "\u{1F4F1} Mobile", 750, 180, { w: 200, h: 80, fill: "rgba(0,212,255,0.12)", borderColor: C.accent1 }),
      box("arch-cli", "\u2328\uFE0F CLI", 1150, 180, { w: 200, h: 80, fill: "rgba(0,212,255,0.12)", borderColor: C.accent1 }),
      // API Gateway
      box("arch-gw", "\u{1F500} API Gateway", 750, 370, { w: 260, h: 90, fill: "rgba(0,255,136,0.12)", borderColor: C.accent4 }),
      // Services tier
      box("arch-auth", "\u{1F510} Auth", 250, 570, { w: 200, h: 80, fill: "rgba(124,92,191,0.15)", borderColor: C.accent2 }),
      box("arch-users", "\u{1F465} Users", 600, 570, { w: 200, h: 80, fill: "rgba(124,92,191,0.15)", borderColor: C.accent2 }),
      box("arch-orders", "\u{1F4E6} Orders", 950, 570, { w: 200, h: 80, fill: "rgba(124,92,191,0.15)", borderColor: C.accent2 }),
      box("arch-notify", "\u{1F514} Notify", 1300, 570, { w: 200, h: 80, fill: "rgba(124,92,191,0.15)", borderColor: C.accent2 }),
      // Data tier
      box("arch-pg", "\u{1F418} PostgreSQL", 400, 800, { w: 220, h: 80, fill: "rgba(255,107,157,0.12)", borderColor: C.accent3 }),
      box("arch-redis", "\u26A1 Redis", 800, 800, { w: 200, h: 80, fill: "rgba(255,107,157,0.12)", borderColor: C.accent3 }),
      box("arch-queue", "\u{1F4EC} Queue", 1200, 800, { w: 200, h: 80, fill: "rgba(255,107,157,0.12)", borderColor: C.accent3 }),
      ...
      connect("arch-users", "arch-redis", {
        ...
        thickness: 1,
        label: "cache",
        labelStyle: { color: C.accent5, fontSize: "12px" }
      }),
      ...
      connect("arch-auth", "arch-redis", {
        ...
        dash: "3 3",
        label: "sessions",
        labelStyle: { color: C.textSec, fontSize: "12px" }
      })
    ]
  };
  var slide7 = {
...
//# sourceMappingURL=connector_demo_bundle.js.map
