...
import { render, _setLayoutFn } from './src/renderer.js';
...
import { grid, snap, resolvePercentage, repeat, rotatedAABB } from './src/utilities.js';
...
// =============================================================================
// Basic Renderer (M1.4) — extracted to src/renderer.js
// =============================================================================
...
// Inject layout function into renderer module (avoids circular import)
_setLayoutFn(layout);

// =============================================================================
// Updated Renderer — Uses Layout Solve (M3.3) — extracted to src/renderer.js
// =============================================================================

// Compound Primitives — connect, panel, figure — extracted to src/compounds.js
