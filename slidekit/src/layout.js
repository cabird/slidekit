// Layout Solve Pipeline — extracted from slidekit.js
// Contains getEffectiveDimensions() and the full layout() pipeline

import { _config, _safeRectCache, set_transformIdCounter } from './state.js';
...
import { resolvePercentage, rotatedAABB } from './utilities.js';
import { isRelMarker, deepClone, flattenElements, getRelRef, resolveRelMarker, buildProvenance, computeAABBIntersection } from './layout/helpers.js';
