...
1. **Phase 1 — Intrinsic Sizes:** Measures HTML content via `measure()`, resolves stack sizes bottom-up, resolves percentage strings, handles panel auto-height
...
4. **Phase 4 — Finalize:** Builds provenance, resolves connector endpoints, AABB collision detection, safe zone/bounds/clustering validation
