...
`;
  ...
  var PLACEHOLDER_SVG = `data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300"><rect fill="%23334" width="400" height="300"/><text x="200" y="150" text-anchor="middle" fill="white" font-size="20">Image</text></svg>`;
  async function run() {
    await init({
      slide: { w: 1920, h: 1080 },
      safeZone: { left: 120, right: 120, top: 90, bottom: 90 },
    ...
    const slides = [
      ...
      // ================================================================
      {
        ...
        elements: [
          ...
          el(`<div style="width:100%;height:1px;background:rgba(255,255,255,0.15);"></div>`, { id: "s4-crossH", x: 460, y: 540, w: 1e3, h: 1 }),
  ...
  return __toCommonJS(stress_test_exports);
})();
